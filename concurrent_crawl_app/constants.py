...
BASE_PROBES = (
    ...
    ProbeSpec("llms_txt", "/llms.txt", "llms", max_bytes=500_000, control_group="text"),
    ProbeSpec("llms_full_txt", "/llms-full.txt", "llms", max_bytes=1_000_000, control_group="text"),
